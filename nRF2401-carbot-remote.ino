/*
 * Demonstration remote controlled car code
 *
 ...
 * chassis.
 *
 * The car this was written for is 2 powered by wheels plus a third idler for
...
void nextSpeed( unsigned long nowTime )
{
  ...
  // quicker: make more responsive to changing control inputs, without (much)
  // affecting configured overall acceleration performance.

  // Assumption is there should never be one wheel accelerating while another
